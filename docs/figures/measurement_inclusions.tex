...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[decoration=zigzag,scale=0.5,transform shape]
  		...
  		\filldraw[fill=gray!30, draw=gray!80] (1.6,0) ellipse (3.2cm and 1.6cm);
  		\filldraw[fill=gray!40, draw=gray!80] (0,0) ellipse (1.6cm and 0.8cm) node {LOCC};
	\node at (3.2,0) {SEP};  			
	\node at (6.4,0) {PPT};
	\node at (9.6,0) {POS (global)};
		\end{tikzpicture}
	\end{center}
